...
df_vaccinations = pd.read_csv('df_vaccinations.csv')
df_beds = pd.read_csv('df_beds.csv')
...
### Get train data
df_deaths_train = pd.read_csv('df_deaths_train.csv')
df_beds_train = pd.read_csv('df_beds_train.csv')
